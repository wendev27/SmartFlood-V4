...
const barangayMappings: Record<string, BarangayMapping> = {
  ...
  "2": { barangay_id: 2, barangay_name: "Barangay Longos" },
  "barangay 2": { barangay_id: 2, barangay_name: "Barangay Longos" },
  "barangay longos": { barangay_id: 2, barangay_name: "Barangay Longos" },
  longos: { barangay_id: 2, barangay_name: "Barangay Longos" },
